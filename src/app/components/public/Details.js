            ...
            <div>
                ...
                <div style={{padding: '45px 6px 0 6px'}}>
                    ...
                    <div className='basic-msg'>
                        <ul>
                            <li><span>网站:</span><span>262</span></li>
                            <li><span>客户编号:</span><span>262</span></li>
                            <li><span>商户名称:</span><span>泰囧回访</span></li>
                            <li><span>所属行业:</span><span>262</span></li>
                            <li><span>客户状态:</span><span>潜在客户</span></li>
                            <li><span>销售负责人:</span><span>管理员</span></li>
                            <li><span>上级单位:</span><span>262</span></li>
                            <li><span>客户类型:</span><span>普通客户</span></li>
                            <li><span>公司传真:</span><span>262</span></li>
